...
export class UserAccountService {
  ...
  public getUserById(id: string): Observable<UserAccounts> {
    return this.http.get<UserAccounts>(this.userApiUrl + 'getById/' + id);
  }
  public CheckEmail(email: string): Observable<boolean> {
    return this.http.get<boolean>(this.userApiUrl + email);
  }
  ...
  public putUser(user: UserAccounts, id: string): Observable<UserAccounts> {
    return this.http.put<UserAccounts>(this.userApiUrl +'editUser/'+ id, user);
  }
